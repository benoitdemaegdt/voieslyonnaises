        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          >
            ...
            <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
              <NuxtLink to="/plan" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 sm:px-8"> Plan </NuxtLink>
              <NuxtLink to="/avancement" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-green-700 bg-white hover:bg-green-50 sm:px-8"> Avancement </NuxtLink>
            </div>
            </div>
          </div>
          <div
